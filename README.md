...
### Output:
<img width="518" height="582" alt="image" src="https://github.com/user-attachments/assets/64a779be-db1f-42ec-adde-d3c8564d99ec" />

### Result:

Thus the python program to implement Information Retrieval Using Vector Space Model was executes successfully.
